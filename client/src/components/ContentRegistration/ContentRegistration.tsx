                ...
                <form className='xl:ml-[100px]'>
                    <div className=' flex flex-col items-center'>
                        ...
                        {location.pathname === '/register' && (
                            <>
                                <Input placeholder='name & last name' className='text-[#FF385C] border-[#FF385C] w-[80%] mb-10 focus-visible:outline-[#FF385C]
                                sm:w-[100%] md:w-[100%] lg:w-[100%] xl:w-[340px]' />
                                <Input placeholder='email' className='text-[#FF385C] border-[#FF385C] w-[80%] mb-10 focus-visible:outline-[#FF385C]
                                sm:w-[100%] md:w-[100%] lg:w-[100%] xl:w-[100%]' />
                                <Input placeholder='password' className='text-[#FF385C] border-[#FF385C] w-[80%] mb-10 focus-visible:outline-[#FF385C]
                                sm:w-[100%] md:w-[100%] lg:w-[100%] xl:w-[100%]' />
                            </>
                        )}
